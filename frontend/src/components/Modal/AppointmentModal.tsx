...
import { Appointment, APPOINTMENT_TYPES, getAppointmentColor, RecurrenceInterval } from "../../types/appointment";
import { CircularProgress, Alert, FormControlLabel, Checkbox, FormControl, InputLabel, Select, MenuItem, TextField } from "@mui/material";
    ...
    if (!formInitialized) {
      if (isEditing && appointment) {
        ...
        setFormData({
          ...
          recurrenceInterval: appointment.recurrenceInterval || RecurrenceInterval.Daily,
    ...
    >
      ...
      >
        <div className="modal-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 20px", borderBottom: "1px solid #eee" }}>
          <h2 style={{ margin: 0, fontSize: "1.5rem" }}>{isEditing ? 'Edit Appointment' : 'New Appointment'}</h2>
          <button className="close-btn" onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "1.5rem" }}>
            <CloseIcon />
          </button>
        </div>
        ...
        <div style={{ padding: "20px" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group" style={{ marginBottom: "16px" }}>
              <label htmlFor="type" style={{ display: "block", marginBottom: "6px", fontWeight: 500 }}>Appointment Type *</label>
              <select
                id="type"
                name="type"
                value={formData.type}
            ...
            <div className="form-group time-inputs" style={{ display: "flex", gap: "16px", marginBottom: "16px" }}>
              <div className="time-input" style={{ flex: 1 }}>
                <label htmlFor="startTime" style={{ display: "block", marginBottom: "6px", fontWeight: 500 }}>Start Time *</label>
                <input
                  type="time"
                  id="startTime"
                  name="startTime"
              ...
              <div className="time-input" style={{ flex: 1 }}>
                <label htmlFor="endTime" style={{ display: "block", marginBottom: "6px", fontWeight: 500 }}>End Time *</label>
                <input
                  type="time"
                  id="endTime"
                  name="endTime"
            ...
            {timeError && (
              <div className="error-message" style={{ marginTop: '-10px', marginBottom: '10px', color: '#f44336', fontSize: '0.875rem' }}>
                {timeError}
              </div>
            )}
            
            <div className="form-group" style={{ marginBottom: "16px" }}>
              <label htmlFor="location" style={{ display: "block", marginBottom: "6px", fontWeight: 500 }}>Location</label>
              <input
                type="text"
                id="location"
                name="location"
            ...
            <div className="form-group" style={{ marginBottom: "16px" }}>
              <label htmlFor="attendees" style={{ display: "block", marginBottom: "6px", fontWeight: 500 }}>Attendees</label>
              <input
                type="text"
                id="attendees"
                name="attendees"
            ...
            <div className="form-group" style={{ marginBottom: "16px" }}>
              ...
              <textarea
                ...
                rows={3}
                style={{ width: "100%", padding: "8px 12px", borderRadius: "4px", border: "1px solid #ccc", resize: "vertical" }}
              />
            </div>
              ...
              {formData.isRecurring && (
                <div style={{ marginTop: '10px' }}>
                  <FormControl fullWidth style={{ marginBottom: '15px' }}>
                    <InputLabel id="recurrence-interval-label">Repeat every</InputLabel>
                    <Select
                    ...
                    >
                      ...
                      <MenuItem value={RecurrenceInterval.Weekly}>Week</MenuItem>
                      <MenuItem value={RecurrenceInterval.Monthly}>Month</MenuItem>
                    </Select>
                  </FormControl>
